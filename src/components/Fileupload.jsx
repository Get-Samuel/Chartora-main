    ...
    return(
        <>
            <div className="flex gap-2 filePreviewAppear border-1 border-stroke w-full md:p-3 md:pr-8 p-2 bg-hightlight justify-between rounded-3xl">
                ...
                <div className="flex md:absolute right-0 -top-2 text-white text-xl cursor-pointer md:p-1 p-2 rounded-full bg-primary border-1 border-stroke active:scale-90 animation-all duration-300"><IoClose/></div>
            </div>
        </>
    )
}
