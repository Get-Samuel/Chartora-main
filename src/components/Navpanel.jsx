...
function Navpanel ({setOpened, navOpened}) {
    ...
    return(
    <>
        <div className="flex flex-col bg-backdrop gap-2 md:max-w-[24%] w-[100vw] h-[100%] p-2 md:p-4 sidebar-container expand-width md:border-1 border-stroke transition-colors duration-500 ease-in-out">
